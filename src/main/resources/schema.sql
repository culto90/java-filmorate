...
CREATE UNIQUE INDEX IF NOT EXISTS user_id_uniq_indx ON users(user_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS friendship_id_uniq_indx ON friendships(friendship_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS mpa_rating_id_uniq_indx ON mpa_ratings(mpa_rating_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS film_id_uniq_indx ON films(film_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS like_id_uniq_indx ON likes(like_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS genre_id_uniq_indx ON genres(genre_id);

CREATE TABLE IF NOT EXISTS film_genres(
	film_genre_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	film_id INT,
	genre_id INT,
	CONSTRAINT fk_genre_film_id FOREIGN KEY (film_id) REFERENCES films(film_id),
	CONSTRAINT fk_genre_id FOREIGN KEY (genre_id) REFERENCES genres(genre_id)
);

CREATE UNIQUE INDEX IF NOT EXISTS film_genre_id_uniq_indx ON film_genres(film_genre_id);
